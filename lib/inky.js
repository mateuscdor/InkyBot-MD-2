...
const exifImageToWebp = (media, data) => {
    ...
    return new Promise(() => {
        ffmpeg(nameJpg)
            ...
            var json = { "sticker-pack-id": 'InkyGod03', "sticker-pack-name": data.packname ? data.packname : "Inky", "sticker-pack-publisher": data.author ? data.author : "God", "emojis": data.categories ? data.categories : [""] }
...
module.exports = { exifImageToWebp, imageToWebp, videoToWebp, ytmp3, ytmp4 }
